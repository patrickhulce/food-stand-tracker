...
public class PaymentActivityTest extends ActivityInstrumentationTestCase2<PaymentActivity>{
	...
	public void testUpdateItemsAdvanced() {
		...
		Button submit = (Button) act.findViewById(edu.upenn.cis350.project.R.id.submit);
		assertTrue(submit.isEnabled());
    	TextView items = (TextView) act.findViewById(edu.upenn.cis350.project.R.id.items);
